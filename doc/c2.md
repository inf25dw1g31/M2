...
> **[INSERIR AQUI]**  
> ![Arquitetura do Sistema](./imagens/c2/image3.png)
...
### 2.4.2 Descrição das Principais Tabelas
...
## 2.5 Regras de Integridade (DELETE)
...
### **2.5.1 Regras de Eliminação de Veículos**
...
### **2.5.2 Regras de Eliminação de Clientes**
...
### **2.5.3 Regras de Eliminação de Funcionários**
...
---
## 2.6 Documentação da API (OpenAPI 3.0)
...
### 2.6.1 Estrutura do Ficheiro `openapi.yaml`
...
### 2.6.2 Estrutura das Secções `paths` e `components` no OpenAPI
...
### 2.6.3 Importância da Documentação OpenAPI
...
### 2.6.4 Exemplo de Definição YAML – Listar Clientes
...
```
### 2.6.5 Exemplo de Filtros YAML – Listar Veículos com Query Parameters
...
```
### 2.6.6 Exemplo YAML – Schema da Relação Favoritos (N:N)
...
# 2.7.1 Ligação à Base de Dados (Excerto de Código)
