...
> ![Arquitetura do Sistema](./image/img1.png)
...
```
## 3.4 Execução com Docker (Versão Final)
...
## 3.4.1 Dockerfile da API (`inf25dw1g31:10.0.0`)
...
## 3.4.2 Dockerfile da Base de Dados (`inf25dw1g31-mysql:10.0.0`)
...
## 3.4.3 Ficheiro docker-compose.prod.yml (Versão Produção)
...
## 3.4.5 Vantagens da Abordagem Docker
...
### 3.5.7 Padrão de tratamento de erros e respostas
...
### 3.5.8 Triggers SQL e interação com a API
...
#### 3.5.8.1 Trigger `veiculo_criado_gera_manutencao`
**Objetivo:**  
...
## **3.5.8.2 Trigger `veiculo_sai_de_manutencao_apaga_manutencoes`**
...
### **3.5.8.3 Trigger `manutencao_criada_muda_estado`**
...
### **3.5.8.4 Trigger `manutencao_atualizada_muda_estado`**
...
### **3.5.8.5 Integração com a API e efeitos globais**
