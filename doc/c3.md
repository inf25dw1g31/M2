...
Esta imagem extende o MySQL oficial para incluir:

- criação automática da BD `car_maintenance`  
- criação do utilizador `car`  
- permissões configuradas  
- import automático das tabelas iniciais  
...
## 3.2.7 Ficheiro docker-compose.yml (Versão Final)
...
services:
  mysql:
    image: a046363/inf25dw1g31-mysql:5.0.0        
  ...
  api:
    image: a046363/inf25dw1g31:5.0.0      
